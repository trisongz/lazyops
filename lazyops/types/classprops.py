"""
Borrowed from https://docs.astropy.org/en/stable/_modules/astropy/utils/decorators.html#classproperty
"""
...
def deprecated(since, message='', name='', alternative='', pending=False, obj_type=None, warning_type=DeprecationWarning):
    """
