...
class BaseStatefulBackend(collections.abc.MutableMapping):
    ...
    async def aget(self, key: str, default: Optional[Any] = None, _raw: Optional[bool] = None, **kwargs) -> Optional[Any]:
        ...
        Gets a Value from the DB
        """
        return await ThreadPool.run_async(self.get, key, default, _raw = _raw, **kwargs)

    async def aget_values(self, keys: Iterable[str], **kwargs) -> List[Any]:
        """
        Gets a Value from the DB
        """
        return await ThreadPool.run_async(self.get_values, keys, **kwargs)
    ...
    async def aset(self, key: str, value: Any, ex: Optional[int] = None, _raw: Optional[bool] = None, **kwargs) -> None:
        ...
        Saves a Value to the DB
        """
        return await ThreadPool.run_async(self.set, key, value, ex, _raw = _raw, **kwargs)
    ...
    async def aset_batch(self, data: Dict[str, Any], ex: Optional[int] = None, **kwargs) -> None:
        ...
        Saves a Value to the DB
        """
        return await ThreadPool.run_async(self.set_batch, data, ex, **kwargs)

    async def adelete(self, key: str, **kwargs) -> None:
        """
        Deletes a Value from the DB
        """
        return await ThreadPool.run_async(self.delete, key, **kwargs)

    async def aclear(self, *keys: str, **kwargs):
        """
        Clears the Cache
        """
        return await ThreadPool.run_async(self.clear, *keys, **kwargs)
    ...
    async def aget_all_data(self, exclude_base_key: Optional[bool] = False, **kwargs) -> Dict[str, Any]:
        ...
        Loads all the Data
        """
        return await ThreadPool.run_async(self.get_all_data, exclude_base_key = exclude_base_key, **kwargs)

    async def aget_all_keys(self, exclude_base_key: Optional[bool] = False, **kwargs) -> List[str]:
        """
        Returns all the Keys
        """
        return await ThreadPool.run_async(self.get_all_keys, exclude_base_key = exclude_base_key, **kwargs)

    async def aget_all_values(self,  **kwargs) -> List[Any]:
        """
        Returns all the Values
        """
        return await ThreadPool.run_async(self.get_all_values, **kwargs)
    ...
    def pop(self, key, default = None, **kwargs):
        ...
        if self.async_enabled:
            ThreadPool.create_background_task(self.adelete(key))
        else:
            self.delete(key)
    ...
    async def acontains(self, key: str, **kwargs) -> bool:
        ...
        Returns True if the Cache contains the Key
        """
        return await ThreadPool.run_async(self.contains, key, **kwargs)
    ...
    def __setitem__(self, key, value):
        ...
        """
        return ThreadPool.create_background_task(self.aset(key, value)) if \
    ...
    def __delitem__(self, key):
        ...
        """
        return ThreadPool.create_background_task(self.adelete(key)) if \
    ...
    async def aget_all_data_raw(self, exclude_base_key: Optional[bool] = False, **kwargs) -> Dict[str, Any]:
        ...
        Loads all the Data
        """
        return await ThreadPool.run_async(self.get_all_data_raw, exclude_base_key = exclude_base_key, **kwargs)
    ...
    async def aload_data_raw(self, data: Dict[str, Any], includes_base_key: Optional[bool] = False, **kwargs):
        ...
        Loads the Data
        """
        return await ThreadPool.run_async(self.load_data_raw, data, includes_base_key = includes_base_key, **kwargs)
    ...
    async def adump_data_raw(self, include_base_key: Optional[bool] = False, **kwargs) -> Dict[str, Any]:
        ...
        Dumps the Data
        """
        return await ThreadPool.run_async(self.dump_data_raw, include_base_key = include_base_key, **kwargs)
    ...
    async def areplicate_from(self, source: Any, **kwargs):
        ...
        Replicates the Cache from a Source
        """
        return await ThreadPool.run_async(self.replicate_from, source, **kwargs)
    ...
    async def asadd(self, key: str, *values: Any, **kwargs) -> int:
        ...
        Adds the value to the set
        """
        return await ThreadPool.run_async(self.sadd, key, *values, **kwargs)
    ...
    async def aslength(self, key: str, **kwargs) -> int:
        ...
        Returns the length of the set
        """
        return await ThreadPool.run_async(self.slength, key, **kwargs)
    ...
    async def asismember(self, key: str, value: Any, **kwargs) -> bool:
        ...
        Returns whether the value is a member of the set
        """
        return await ThreadPool.run_async(self.sismember, key, value, **kwargs)
    ...
    async def asembers(self, key: str, **kwargs) -> List[Any]:
        ...
        Returns the members of the set
        """
        return await ThreadPool.run_async(self.smembers, key, **kwargs)
    ...
    async def asmismember(self, key: str, *values: Any, **kwargs) -> bool:
        ...
        Returns whether the values are members of the set
        """
        return await ThreadPool.run_async(self.smismember, key, *values, **kwargs)
    ...
    async def asrem(self, key: str, *values: Any, **kwargs) -> int:
        ...
        Removes the value from the set
        """
        return await ThreadPool.run_async(self.srem, key, *values, **kwargs)
    ...
    async def aspop(self, key: str, **kwargs) -> Any:
        ...
        Removes and returns a random member of the set
        """
        return await ThreadPool.run_async(self.spop, key, **kwargs)
    ...
    async def amigrate_schema(self, schema_map: Dict[str, Any], overwrite: Optional[bool] = None, **kwargs) -> None:
        ...
        Migrates the schema
        """
        await ThreadPool.run_async(self.migrate_schema, schema_map, overwrite = overwrite, **kwargs)
