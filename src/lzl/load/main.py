...
import importlib
from typing import Generic, TypeVar, Any, Dict, Any
...
def lazy_load(name: str, package: str | None = None, install_missing: bool = True, install_options: Dict[str, Any] = None) -> LazyLoad:
    ...
    """
    return LazyLoad(name, package, install_missing, install_options)
