...
from ..types.common import GrantType
from ..base import get_kinde_temp_data, lib_path, templates_path, staticfile_path, KindeContext, KindeContextObject
from .utils import get_hashed_key, encrypt_key, decrypt_key, aencrypt_key, adecrypt_key, create_random_string, normalize_url_name, get_current_year, get_env_value
...
class KindeSettings(BaseSettings):
    ...
    user_profile_path: Optional[str] = '/user-profile'
    ...
    class Config:
        ...
        extra = 'allow'
        env_file = get_env_value('KINDE_ENV_FILE', default = None)
    ...
    def data(self) -> 'PersistentDict[str, Dict[str, Any]]':
        ...
        if 'data' not in self._extra:
            ...
            if self.app_name:
                ...
                base_key += f'{normalize_url_name(self.app_endpoint)}.'
